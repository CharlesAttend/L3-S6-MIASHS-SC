...
\begin{defn}[Fonction de répartition empirique]
    ...
    \begin{figure}[!htbp]
        \centering
        \includegraphics*[width=.75 \textwidth]{./src/fig1.png}
...
\begin{thm}[Glivenko-Cantelli]
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics*[width=.75 \textwidth]{./src/fig2.jpg}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics*[width=.75\textwidth]{./src/fig3.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics*[width=.75\textwidth]{./src/fig4.png}
...
\begin{rem}[].
    \begin{enumerate}
        ...
        \item Si $ n $ et $ m $ sont trop grands, on utilise le résultat suivant : \\
            ...
            \begin{figure}[!htb]
                \centering
                \includegraphics*[width=0.5\textwidth]{./src/fig5.jpg}
                \caption{<caption>}
                \label{<label>}
            \end{figure}
...
\begin{figure}[!h]
    \centering
    \includegraphics*[width=.6 \textwidth]{./src/fig6.jpg}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \includegraphics*[width=.75\textwidth]{./src/fig7.png}
\end{figure}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics*[width=0.75\textwidth]{./src/fig8.jpg}
